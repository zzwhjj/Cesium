...
define(['./when-e6985d2a', './Check-24cae389', './Math-392d0035', './Cartesian2-27e3267e', './Transforms-6a94927e', './RuntimeError-61701d3e', './WebGLConstants-34c08bc0', './ComponentDatatype-cb08e294', './AttributeCompression-c6a20ed1', './IndexDatatype-1be7d1f8', './IntersectionTests-eac3000a', './Plane-fc881d50', './WebMercatorProjection-7fb94d88', './createTaskProcessorWorker', './EllipsoidTangentPlane-1b21e92a', './OrientedBoundingBox-8f8e117b', './TerrainEncoding-4c79d222'], function (when, Check, _Math, Cartesian2, Transforms, RuntimeError, WebGLConstants, ComponentDatatype, AttributeCompression, IndexDatatype, IntersectionTests, Plane, WebMercatorProjection, createTaskProcessorWorker, EllipsoidTangentPlane, OrientedBoundingBox, TerrainEncoding) { 'use strict';
