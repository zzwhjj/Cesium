...
define(['./when-e6985d2a', './Check-24cae389', './Math-392d0035', './Cartesian2-27e3267e', './Transforms-6a94927e', './RuntimeError-61701d3e', './WebGLConstants-34c08bc0', './AttributeCompression-c6a20ed1', './IndexDatatype-1be7d1f8', './IntersectionTests-eac3000a', './Plane-fc881d50', './createTaskProcessorWorker', './EllipsoidTangentPlane-1b21e92a', './OrientedBoundingBox-8f8e117b', './Color-e0cd3ce9'], function (when, Check, _Math, Cartesian2, Transforms, RuntimeError, WebGLConstants, AttributeCompression, IndexDatatype, IntersectionTests, Plane, createTaskProcessorWorker, EllipsoidTangentPlane, OrientedBoundingBox, Color) { 'use strict';
